    ...
    <div className='plan-items'>
      ...
      <div className='plan-items_block'>
        ...
        <div className='plan-items_block--second-text'>
          ...
          <p>
            API - это механизмы, которые позволяют двум программным компонентам взаимодействовать
            друг с другом, используя набор определений и протоколов.
          </p>
        </div>
        <ul>
