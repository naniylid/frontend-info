  ...
  return (
    ...
    <div className='plan-items'>
      ...
      >
        ...
        <div className="line ">
          <p>
            Не уделяй все время теории. Допустим у тебя есть 3 часа на обучение
            в день. 1 час читай теорию, а в остальные два практикуй изученный
            материал. Рекомендую регулярно решать задачи на LeetCode или
            CodeWars.
          </p>
          <p>Практика</p>
      ...
      >
        ...
        <div className="line ">
          <p>
            Если ты хорошо знаешь JS, то ты без проблем можешь изучить все 3. Я
            пока что выбрала React, так как он самый популярный. На React
            рекомендую написать 1-2 крупных проекта для портфолио.
          </p>
          <ul>
      ...
      >
        ...
        <div className="line ">
          <p>
            Изучить основы. Достаточно почитать официальную документацию и
            посмотреть практику на YouTube.
          </p>
          <ul>
            <li>
      ...
      >
        ...
        <div className="line ">
          <p>
            Рекомендую репозиторий Практиковаться на LeetCode и Codewars
            GeeksforGeeks: GeeksforGeeks предоставляет обширные материалы по
            алгоритмам, структурам данных и множеству практических задач.
            HackerRank предоставляет практические задачи по различным темам,
            включая алгоритмы и структуры данных.
          </p>
          <ul>
            <li>
        ...
        <div className="line ">
          ...
          <div className="plan-items_block--list">
            ...
            <div className="plan-items_block--list__text">
              <div className="line ">
                <p>
                  WEBPACK - это статический модульный сборщик для приложений на
                  JavaScript.
                </p>
                <ul>
                  <li>
